...
#{'noise_type': 'uniform-linf', 'epsilon': 0.05, 'sphere': False, 'distribution': 'beta2-5'},
#{'noise_type': 'gaussian', 'epsilon': 0.05, 'sphere': False, 'distribution': 'beta2-5'},
#{'noise_type': 'uniform-l0-impulse', 'epsilon': 0.1, 'sphere': False, 'distribution': 'beta2-5'}
])
